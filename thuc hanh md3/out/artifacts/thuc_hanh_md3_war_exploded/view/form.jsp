            ...
            <form method="post">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Category Here.." class="form-control"
                               name="category">
                    ...
                    <button type="submit" class="btn btn-lg btn-info"><a href="/product?action=create">Submit</a></button>
                </div>
            </form>
        </div>
    </div>
